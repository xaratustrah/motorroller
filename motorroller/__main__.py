...
def main():
    ...
    parser.add_argument(
        '-c', '--command', nargs=1, type=str, help='Enter command as an argument.', default=''
    )
    parser.add_argument('--server', action=argparse.BooleanOptionalAction, help = 'Start in client / server mode.')
